...
Shop.Chests = {
	...
	["506"] = {{706,60},{803,40},{41,60},{31,60},{35,40},{103,60},{607,10},{608,5},{609,5}, 	{"gold", 20, {20, 200} } },
	...
	["509"] = {{709,60},{806,40},{5,60},{10,60},{32,20},{133,10},{612,10},{616,5},{617,5}, 	{"gold", 20, {35, 350} } },
	...
	--66
	["514"] = {{601,60},{602,60},{603,50},{604,20},{605,40},{606,30},{607,20},{608,10},{609,10}, 	{"gold", 20, {100, 1000} } },
	...
	["520"] = {{714,60},{718,60},{45,60},{34,60},{52,20},{605,10},{606,10},{629,5},{626,5}, 	{"gold", 20, {35, 350} } },
				...
				for pID=0,DOTA_MAX_TEAM_PLAYERS do
					if PlayerResource:IsValidPlayerID(pID) then
						if GameRules.Mute[pID] == nil then
							...
							EmitSoundOnClient(sound_name, hero:GetPlayerOwner())
